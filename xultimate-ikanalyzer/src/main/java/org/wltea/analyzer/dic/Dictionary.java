...
public class Dictionary {
	 ...
	 * @param words 词条列表。
	 */
	public void addQuantifierWordsWords(Collection<String> quantifierWords){
		if(quantifierWords != null){
			for(String word : quantifierWords){
				if (word != null) {
					//批量加载词条到主内存词典中
					singleton._QuantifierDict.fillSegment(word.trim().toLowerCase().toCharArray());
				}
			}
		}
	}
	 ...
	 * @param words 词条列表。
	 */
	public void disableQuantifierWords(Collection<String> quantifierWords){
		if(quantifierWords != null){
			for(String word : quantifierWords){
				if (word != null) {
					//批量屏蔽词条
					singleton._QuantifierDict.disableSegment(word.trim().toLowerCase().toCharArray());
				}
			}
		}
	}
